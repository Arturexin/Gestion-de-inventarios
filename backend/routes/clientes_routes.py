...
clientes_db = Blueprint('clientes_db', __name__)
proveedores_db = Blueprint('proveedores_db', __name__)
...
@clientes_db.route('/api/clientes_db')#CLIENTES, INDEX, VENTAS
@cross_origin()
...
@proveedores_db.route('/api/proveedores_db')# CLIENTES, INDEX
@cross_origin()
...
def createCliente():
    ...
    try:
        with mysql.connection.cursor() as cur:
            ...
            # Obtener el ID del nuevo cliente creado
